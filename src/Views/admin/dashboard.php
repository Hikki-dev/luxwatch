...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-luxury-heading">Admin Dashboard</h1>
        <p class="text-gray-600">Manage your luxury watch e-commerce platform</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="card-luxury p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    <div class="w-8 h-8 bg-luxury-gold bg-opacity-20 rounded-full flex items-center justify-center">
                        <svg class="w-4 h-4 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-medium">Product approval pending</p>
        ...
        <div class="card-luxury p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="index.php?page=admin&action=users" class="btn-luxury-outline text-center p-4 block">
                ...
                <a href="index.php?page=admin&action=products" class="btn-luxury-outline text-center p-4 block">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    Review Products
                ...
                <a href="index.php?page=admin&action=orders" class="btn-luxury-outline text-center p-4 block">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                    </svg>
                    View Orders
                ...
                <a href="index.php?page=admin&action=analytics" class="btn-luxury-outline text-center p-4 block">
                    <svg class="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
